...
class ShapeScene : public Object
{
public:
	explicit ShapeScene(void);
	ShapeScene(const ShapeScene&) = delete;
	ShapeScene& operator = (const ShapeScene&) = delete;
	~ShapeScene(void);
...
public:
	static std::shared_ptr<ShapeScene> Create(void);
};

typedef std::shared_ptr<ShapeScene> SHAPE;